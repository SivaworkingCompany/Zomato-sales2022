...
public class AppModule
{
	...
	public static void overrideFactorySymbols(MappedConfiguration<String, Object> configuration)
	{
		...
		configuration.override(SymbolConstants.APPLICATION_VERSION, "V1");
	}
	 ...
	 * InternalConstants.TAPESTRY_APP_PACKAGE_PARAM + ".entities" (witch is equal to "Zomato.entities")
	 * for annotated entity classes.
	 *
	 * Contributes the package "Zomato.model" to the configuration, so that it will be
...
//		configuration.add("Zomato.model");
	}
